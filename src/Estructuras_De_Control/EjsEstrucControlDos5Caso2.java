...
public class EjsEstrucControlDos5Caso2 {
    public static void main(String[] args) {
        ...
        System.out.println("%");
        System.out.print("Han aprobado " + sobresaliente + " alumnos con sobresaliente, un " + (sobresaliente*100/total) + "%");
        System.out.println(matrHonor + " alumnos han sacado matrícula de honor, un " + (matrHonor*100/total) + "%");
    }
}